...
downsampling a deferred to Phase 2.
...
| `proton_density_n_cm3` | REAL | Proton number density (cm�뼘�) |
| `plasma_flow_speed_km_s` | REAL | Scalar solar-wind bulk speed (km/s) |
| `plasma_flow_long_angle_deg` | REAL | Azimuthal flow angle �_V (deg) |
| `plasma_flow_lat_angle_deg` | REAL | Latitudinal flow angle 罐_V (deg) |
...
| `sigma_phi_v_deg` | REAL | RMS SD of �_V |
| `sigma_theta_v_deg` | REAL | RMS SD of 罐_V |
| `sigma_na_np` | REAL | RMS SD of alpha ratio |
| `electric_field_mv_m` | REAL | Solar-wind electric field = �뭋 횞 Bz(GSM) 횞 10�뼘� (mV/m) |
| `plasma_beta` | REAL | Plasma 棺 = thermal pressure / magnetic pressure |
| `alfven_mach_number` | REAL | V / V_Alfv챕n |

#### Geomagnetic & Solar-Activity Indices (17)

| Column | Type | Description |
|--------|------|-------------|
| `kp_index` | SMALLINT | Kp 횞 10 (GFZ Potsdam), 3-hour planetary magnetic activity |
...
| `proton_flux_gt1mev` | REAL | Energetic proton integral flux >1 MeV (cm짼 s sr)�뼘� |
...
| `f10_7_index_sfu` | REAL | F10.7 cm solar radio flux at 1 AU, SFU = 10�뼘꼲� W/m짼/Hz |
...
| `proton_density_n_cc` | REAL | Proton number density (cm�뼘�) |
| `temperature_k` | REAL | Proton temperature (K) |
| `flow_pressure_npa` | REAL | Dynamic pressure �� (2횞10�삘겤) 횞 Np 횞 V짼 (nPa) |
| `electric_field_mv_m` | REAL | E = �뭋 횞 Bz(GSM) 횞 10�뼘� (mV/m) |
| `plasma_beta` | REAL | Plasma 棺 |
| `alfven_mach_number` | REAL | (V 횞 �숹p) / (20 횞 \|B\|) |
...
| Column | Type | Description |
|--------|------|-------------|
| `proton_flux_gt10mev` | REAL | GOES proton integral flux >10 MeV (cm짼 s sr)�뼘� |
